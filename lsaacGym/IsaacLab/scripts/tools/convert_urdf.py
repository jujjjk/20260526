...
parser.add_argument(
    ...
    default=False,
    help="Whether to make the generated USD instanceable. Disable this when you need fixed-joint links such as feet"
    " or imu_link to stay visible to runtime sensors.",
)
