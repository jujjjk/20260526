...
class FanfanA1CleanRoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    def __post_init__(self):
        ...
        # Slightly smaller than A1: fanfan benefits from a tighter action range
        # around the now taller nominal pose, which helps prevent re-collapsing
        # into a low dragging gait during early exploration.
